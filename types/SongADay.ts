...
export interface SongADayInterface extends utils.Interface {
  functions: {
    ...
    "totalRemaining()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "totalRemaining",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SongADay extends BaseContract {
  ...
  functions: {
    ...
    totalRemaining(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    totalRemaining(overrides?: CallOverrides): Promise<PopulatedTransaction>;
